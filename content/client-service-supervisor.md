...
* ### CLEAN A TAXPAYER
   ...
   ![Image](./images/client-service-supervisor/CLIENT%20SS%201.png)
---
* ### REGISTRATION
   #### **Tin Registration :**
   ...
   ![Image](./images/client-service-supervisor/CLIENT%20SS%202.png)
   ---
   ...
   ![Image](./images/client-service-supervisor/CLIENT%20SS%203.png) 
   ---
   ...
   ![Image](./images/client-service-supervisor/CLIENT%20SS%204.png)
   ...
   ![Image](./images/client-service-supervisor/CLIENT%20SS%205.png) 
   ...
   ![Image](./images/client-service-supervisor/CLIENT%20SS%206.png)
   ---
   #### **Tin Certificate :**
   ...
   ![Image](./images/client-service-supervisor/CLIENT%20SS%207.png)
   ---
   ...
   ![Image](./images/client-service-supervisor/CLIENT%20SS%208.png)
   ---
   #### **Pending List :**
   ...
   ![Image](./images/client-service-supervisor/CLIENT%20SS%209.png)
   ---
   #### **List Tax Type :**
   ...
   ![Image](./images/client-service-supervisor/CLIENT%20SS%2010.png)
---
* ### TAXPAYER MANAGEMENT
   ---
   ...
   ![Image](./images/client-service-supervisor/CLIENT%20SS%2011.png)
   ---
   ...
   ![Image](./images/client-service-supervisor/CLIENT%20SS%2012.png)
   ---
   ...
   ![Image](./images/client-service-supervisor/CLIENT%20SS%2013.png)
   ---
   #### **Pending List :**
     10. Click on **Pending List**. The list is displayed on the screen.
   
   ![Image](./images/client-service-supervisor/CLIENT%20SS%2014.png)
   ...
   ![Image](./images/client-service-supervisor/CLIENT%20SS%2015.png)
   ...
   ![Image](./images/client-service-supervisor/CLIENT%20SS%2016.png)
   ---
   #### ****
     15. The details of the Taxpayer displays.
   
   ![Image](./images/client-service-supervisor/CLIENT%20SS%2017.png)
   ...
   ![Image](./images/client-service-supervisor/CLIENT%20SS%2018.png)
   ...
   ![Image](./images/client-service-supervisor/CLIENT%20SS%2019.png)
   ---
   ...
   ![Image](./images/client-service-supervisor/CLIENT%20SS%2020.png)
   ---
   ...
   ![Image](./images/client-service-supervisor/CLIENT%20SS%2021.png)
   ---
   ...
   ![Image](./images/client-service-supervisor/CLIENT%20SS%2022.png)
   ---
   ...
   ![Image](./images/client-service-supervisor/CLIENT%20SS%2023.png)
---
* ### TAX TYPE MANAGEMENT
   ---
   ...
   ![Image](./images/client-service-supervisor/CLIENT%20SS%2024.png)
   ---
   ...
   ![Image](./images/client-service-supervisor/CLIENT%20SS%2025.png)
   ---
   ...
   ![Image](./images/client-service-supervisor/CLIENT%20SS%2026.png)
---
* ### GHANA CARD
   ---
   ...
   ![Image](./images/client-service-supervisor/CLIENT%20SS%2027.png)
   ---
   ...
   ![Image](./images/client-service-supervisor/CLIENT%20SS%2028.png)
---
* ### TAXPAYER RETURNS
   ---
   ...
   ![Image](./images/client-service-supervisor/CLIENT%20SS%2029.png)
   ---
   #### **To Search For Taxpayers Return :**
     3. Click on **Search Returns**.
     4. Fill the fields and click **record search**.
   
   ![Image](./images/client-service-supervisor/CLIENT%20SS%2030.png)
   ---
   ...
   ![Image](./images/client-service-supervisor/CLIENT%20SS%2034.png)
   ---
   #### **Filing Extensions :**
   ...
   ![Image](./images/client-service-supervisor/CLIENT%20SS%2035.png)
---
* ### RECEIPTS 
   ---
   ...
   ![Image](./images/client-service-supervisor/CLIENT%20SS%2036.png)
   ---
   #### **To search for Taxpayers receipts :**
     3. The details of the searched receipt will populate.
   
   ![Image](./images/client-service-supervisor/CLIENT%20SS%2037.png)
   ---
   #### **Search GGOV Invoice :**
     4. Click on **Search GGOV Invoice**.
     5. Input the Invoice Number or Tax bill ID and click **Process Print**.
   
   ![Image](./images/client-service-supervisor/CLIENT%20SS%2038.png)
---
* ### ISSUE TAXBILL
   ---
   ...
   ![Image](./images/client-service-supervisor/CLIENT%20SS%2039.png)
---
* ### TAXBILL
   ---
   ####  **Under the Taxbill menu :**
   ...
   ![Image](./images/client-service-supervisor/CLIENT%20SS%2040.png)
--- 
* ### TAXBILL PRINT OUT
   ---
   ...
   ![Image](./images/client-service-supervisor/CLIENT%20SS%2041.png)
...
* ### REGISTER VEHICLE NUMBER
   ...
   ![Image](./images/client-service-supervisor/CLIENT%20SS%2042.png)
---
* ###   ADD VIT STICKER No. TO RECEIPT
   ...
   ![Image](./images/client-service-supervisor/CLIENT%20SS%2043.png)
---
* ###    VIEW VIT DETAIL
   ---
   ...
   ![Image](./images/client-service-supervisor/CLIENT%20SS%2044.png)
---
* ### CASE MANAGEMENT
   ---
   ...
   ![Image](./images/client-service-supervisor/CLIENT%20SS%2045.png)
   ---
   #### **Under Case Management :**
     5. Click on **my Tasks**.
   ...
   ![Image](./images/client-service-supervisor/CLIENT%20SS%2046.png)
   ---
   #### **Under Case Management :**
   ...
   ![Image](./images/client-service-supervisor/CLIENT%20SS%2047.png)
   ---
   ...
   ![Image](./images/client-service-supervisor/CLIENT%20SS%2048.png)
   ---
   ...
   ![Image](./images/client-service-supervisor/CLIENT%20SS%2049.png)
...
* ### OPEN TAXPAYER LEDGER
   ...
   ![Image](./images/client-service-supervisor/CLIENT%20SS%2050.png)
...
* ### TAX CLEARANCE
   ...
   ![Image](./images/client-service-supervisor/CLIENT%20SS%2051.png)
   ---
   ...
   ![Image](./images/client-service-supervisor/CLIENT%20SS%2052.png)
   ---
   ...
   ![Image](./images/client-service-supervisor/CLIENT%20SS%2053.png)
   ---
   ...
   ![Image](./images/client-service-supervisor/CLIENT%20SS%2054.png)
   ---
   #### **To view the E-TCC :**
   ...
   ![Image](./images/client-service-supervisor/CLIENT%20SS%2055.png)
   ---
   ...
   ![Image](./images/client-service-supervisor/CLIENT%20SS%2056.png)
---
* ### VALUE BOOKS
   ---
   ...
   ![Image](./images/client-service-supervisor/CLIENT%20SS%2057.png)
   ---
   ...
   ![Image](./images/client-service-supervisor/CLIENT%20SS%2058.png)
   ---
   ...
   ![Image](./images/client-service-supervisor/CLIENT%20SS%2059.png)
   ---
   ...
   ![Image](./images/client-service-supervisor/CLIENT%20SS%2060.png)
---
* ### ASSESSMENT
   ---
   ...
   ![Image](./images/client-service-supervisor/CLIENT%20SS%2061.png)
   ---
   ...
   ![Image](./images/client-service-supervisor/CLIENT%20SS%2062.png)
   ---
   ...
   ![Image](./images/client-service-supervisor/CLIENT%20SS%2063.png)  
   ---
   ...
   ![Image](./images/client-service-supervisor/CLIENT%20SS%2064.png)
---
* ### REPORT
   ---
   ...
   ![Image](./images/client-service-supervisor/CLIENT%20SS%2065.png)
   ---
   ...
   ![Image](./images/client-service-supervisor/CLIENT%20SS%2066.png)
   ---
   ...
   ![Image](./images/client-service-supervisor/CLIENT%20SS%2067.png)
   ---
   ...
   ![Image](./images/client-service-supervisor/CLIENT%20SS%2068.png)
   ---
   ...
   ![Image](./images/client-service-supervisor/CLIENT%20SS%2069.png)
   ---
   ...
   ![Image](./images/client-service-supervisor/CLIENT%20SS%2070.png)
   ---
   ...
   ![Image](./images/client-service-supervisor/CLIENT%20SS%2071.png)
   ---
   ...
   ![Image](./images/client-service-supervisor/CLIENT%20SS%2072.png)
   ---
   ...
   ![Image](./images/client-service-supervisor/CLIENT%20SS%2073.png)
   ---
   ...
   ![Image](./images/client-service-supervisor/CLIENT%20SS%2074.png)
   ---
   ...
   ![Image](./images/client-service-supervisor/CLIENT%20SS%2075.png)
   ---
   ...
   ![Image](./images/client-service-supervisor/CLIENT%20SS%2076.png)
   ---
   ...
   ![Image](./images/client-service-supervisor/CLIENT%20SS%2077.png)  
   ---
   #### **To View The Return Lodgment Backdates :**
    ...
    ![Image](./images/client-service-supervisor/CLIENT%20SS%2078.png)  
   --- 
   ####  **To View The Registered Tax Types :**
    ...
    ![Image](./images/client-service-supervisor/CLIENT%20SS%2079.png)
   ---
   ####  **To View The Registered Tax Types, Under Taxpayer Reports :** 
    ...
    ![Image](./images/client-service-supervisor/CLIENT%20SS%2080.png) 
   ---
   ####  **To View The Tax Payers Master List :** 
    ...
    ![Image](./images/client-service-supervisor/CLIENT%20SS%2081.png)
   ---
   ####  **To View The Tax Payer List By Tax Type :** 
    ...
    ![Image](./images/client-service-supervisor/CLIENT%20SS%2082.png)
   ---
   #### **To View Newly Registered Tax Payers : **
    ...
    ![Image](./images/client-service-supervisor/CLIENT%20SS%2083.png)
   ---
   #### **To View The Tax Payer Vehicle List :** 
     1. Click on Taxpayer Vehicle List. The list will be displayed.
   
    ![Image](./images/client-service-supervisor/CLIENT%20SS%2084.png)
   ---
   ...
   #### **To View Payments Without Lodgment :** 
    ...
    ![Image](./images/client-service-supervisor/CLIENT%20SS%2089.png)
   ---
   ####  **To View Taxpayers Receipts :** 
    ...
    ![Image](./images/client-service-supervisor/CLIENT%20SS%2090.png)
   ---
